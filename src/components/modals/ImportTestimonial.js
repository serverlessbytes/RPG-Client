...
import { addBulkTestimonial } from '../../redux/testimonial/actionCreator';

function ImportTestimonial({ modaltitle, handleCancel, importModel }) {
...
export default ImportTestimonial